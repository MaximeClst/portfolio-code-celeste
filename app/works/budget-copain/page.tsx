              ...
              <div className="order-1 lg:order-2 space-y-8">
                <Card className="p-6">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Gérer son budget au quotidien est un casse-tête pour beaucoup de
                    monde. Les applis existantes sont soit trop complexes, soit pas
                    adaptées aux réalités locales. L'idée : une app simple, intuitive,
                    qui aide vraiment à suivre ses dépenses sans prise de tête.
                  </p>
                </Card>
                ...
                <Card className="p-6">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Une application mobile React Native / Expo avec une base Supabase.
                    Catégorisation automatique des transactions, suivi budgétaire
                    mensuel, visualisation des dépenses, et onboarding personnalisé.
                    Gratuite à l'utilisation avec un plan premium en option.
                  </p>
                </Card>
                ...
                <Card className="p-6">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    (catégorisation automatique, vues mensuelles) sont déjà en place
